...
import static org.free13.rubik.coder.NamingConverter.underscoreToCamelCase;

/**
 * @author free13 Copyright (c) 2024.
 */
public class RDBScheme2JavaCoder implements RCoder<String> {
    ...
    public String generateJavaClassFromSchema(String tableName, String packageName) throws SQLException {
        ...
        while (columns.next()) {
            ...
            String javaType = TypeConverters.getJavaType(sqlType);
            String sqlTypeStr = TypeConverters.getMySqlType(javaType);
